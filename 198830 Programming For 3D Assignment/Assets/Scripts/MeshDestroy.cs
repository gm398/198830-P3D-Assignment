...
public class MeshDestroy : MonoBehaviour
{
    ...
    private void DestroyMesh()
    {
        ...
        for (var i = 0; i < parts.Count; i++)
        {
            if(this.GetComponent<Rigidbody>() == null) { this.gameObject.AddComponent<Rigidbody>(); }
            parts[i].MakeGameobject(this, this.GetComponent<Rigidbody>());
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original, Rigidbody originalRB)
        {
            ...
            int newCutCascades = original.CutCascades;

            if (original.CutCascades > 0)
            {
                newCutCascades = original.CutCascades - 1;
            }
            meshDestroy.CutCascades = newCutCascades;
